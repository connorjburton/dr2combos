export default {
    ...
    COMBO_CARDS: [
        ...
        {name: "Roaring Thunder", image: "comboc_roaringthunder_result.jpg", filteredImage: "comboc_roaringthunder_no_result.jpg", items: ["Battery", "Goblin Mask"]},
        {name: "Rocket Launcher", image: "comboc_rocketlauncher_result.jpg", filteredImage: "comboc_rocketlauncher_no_result.jpg", items: ["Rocket Fireworks", "Lead Pipe"]},
        {name: "Spear Launcher", image: "comboc_spearlauncher_result.jpg", filteredImage: "comboc_spearlauncher_no_result.jpg", items: ["Leaf Blower", "Spear"]},
